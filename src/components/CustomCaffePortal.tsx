...
import PrototypePortail from "./PrototypePortail";
  ...
  return (
    <div className="min-h-screen bg-[#f5f0e6] text-[#4b3832]">
      <header className="flex flex-col items-center justify-center py-6 border-b border-[#d3bfa6] bg-[#f0e4d7]">
        <img src="/custom-caffe-logo.png" alt="Custom Caffe" width={100} height={100} className="mb-2" />
        <h1 className="text-4xl text-[#6f4e37]">Custom Caffe — Portail RH</h1>
      </header>
